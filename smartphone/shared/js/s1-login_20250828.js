...
$(function() {
    ...
    var url = {
        ...
        smt: "https://stg105-member.rakuten-sec.co.jp/bv/app/SmtMhLogin.do?login_type=1",
        // らくらく投資トップ（スマートフォン） - login_type=1
        rab: "https://stg105-member.rakuten-sec.co.jp/bv/app/SmtMhLogin.do?homeid=SMT_FUNAVI_TOP",
        // 楽ラップトップ（スマートフォン） - login_type=1
        rakurap: "https://stg105-member.rakuten-sec.co.jp/bv/app/SmtMhLogin.do?homeid=WRAP_TOP",
        // 総合トップ（PC） - login_type=1
        pc: "https://stg105-member.rakuten-sec.co.jp/bv/app/MhLogin.do?login_type=1",
        // FX（スマートフォン） - login_type=1
        fx_sp: "https://stg105-member.rakuten-sec.co.jp/bv/app/SmtMhLogin.do?homeid=SMT_FX_SSO_LOGIN",
        // FX（PC） - login_type=1
        fx: "https://stg105-member.rakuten-sec.co.jp/bv/app/MhLogin.do?homeid=FX_SSO_LOGIN",
        // バイナリ―オプション（スマートフォン） - login_type=1
        bo: "https://stg105-member.rakuten-sec.co.jp/bv/app/SmtMhLogin.do?homeid=BO_SSO_LOGIN",
        // 楽天CFD（スマートフォン） - login_type=1
        SMT_NCFD_TOP: "https://stg105-member.rakuten-sec.co.jp/bv/app/SmtMhLogin.do?homeid=SMT_NCFD_TOP",

        // ★新しいフォーム用のURL (login_type=2)
        // 既存のURLからlogin_type=1をlogin_type=2に変更するか、homeidがあれば&login_type=2を追加。
        smt_passkey: "https://stg105-member.rakuten-sec.co.jp/bv/app/SmtMhLogin.do?login_type=2",
        rab_passkey: "https://stg105-member.rakuten-sec.co.jp/bv/app/SmtMhLogin.do?homeid=SMT_FUNAVI_TOP&login_type=2",
        rakurap_passkey: "https://stg105-member.rakuten-sec.co.jp/bv/app/SmtMhLogin.do?homeid=WRAP_TOP&login_type=2",
        pc_passkey: "https://stg105-member.rakuten-sec.co.jp/bv/app/MhLogin.do?login_type=2", // PC版はhomeidがない場合が多い
        fx_sp_passkey: "https://stg105-member.rakuten-sec.co.jp/bv/app/SmtMhLogin.do?homeid=SMT_FX_SSO_LOGIN&login_type=2",
        fx_passkey: "https://stg105-member.rakuten-sec.co.jp/bv/app/MhLogin.do?homeid=FX_SSO_LOGIN&login_type=2",
        bo_passkey: "https://stg105-member.rakuten-sec.co.jp/bv/app/SmtMhLogin.do?homeid=BO_SSO_LOGIN&login_type=2",
        SMT_NCFD_TOP_passkey: "https://stg105-member.rakuten-sec.co.jp/bv/app/SmtMhLogin.do?homeid=SMT_NCFD_TOP&login_type=2",
    };
...
if (rg == null) {
  ...
  if(flg == 1) {
    jQuery("#passkey-check").addClass("section--passkey");
  }
}
