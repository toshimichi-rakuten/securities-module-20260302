...
function showLink(device) {
	...
	if(device.isIPhone()) {
		isSmartphone = true;
		linkField.innerHTML = '<a href="https://www.rakuten-sec.co.jp/web/fund/smartphone/products/fund/?l-id=web_fund_spbnr"><img src="/web/images/index-btn-fund-site.jpg" border="0"></a>';
