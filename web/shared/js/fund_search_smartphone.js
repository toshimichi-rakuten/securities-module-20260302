...
function showLink(device) {
	...
	if(device.isIPhone()) {
		isSmartphone = true;
		linkField.innerHTML = '<a href="https://www.rakuten-sec.co.jp/web/fund/smartphone/products/fund/search/?l-id=web_fund_search_spbnr"><img src="/web/images/index-btn-fund-search.jpg" border="0"></a>';
