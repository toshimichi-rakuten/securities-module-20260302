...
function createInfo(){
  ...
  $.ajax({
    async : false,
    url : "/web/shared/json/info/info_cfd.json",
    type : "get",
    dataType : "json",
    cache : false,
    success : function(data){
      ...
      for(var i=0; i < data.length; i++) {
        ...
        str1 = str1 +
          ...
          '<div class="s1-list-info__content"><a href="'+n.pc_url+'"target="'+n.blank+'" data-ratid="cfd_info_'+n.slid+'" data-ratevent="click" data-ratparam="all">'+n.txt+'</a></div>'+
          '</li>';
        cnt1++;
        }
