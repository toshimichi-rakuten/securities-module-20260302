...
function change_tab(){
	if(focus_flag == 0){
	 ...
	 document.getElementById('key_tab0').innerHTML ="<img src=\"/web/shared/images/fixed/keyboard/keyboard_tab_idon.gif\" alt=\"ログインID\" />";
	 document.getElementById('key_tab1').innerHTML ="<img style=\"CURSOR: pointer\" onclick=chfocus(1)  ondblclick=chfocus(1) src=\"/web/shared/images/fixed/keyboard/keyboard_tab_passoff.gif\" alt=\"パスワード\" />";
	 ...
	 document.getElementById('key_tab0').innerHTML ="<img style=\"CURSOR: pointer\" onclick=chfocus(0)  ondblclick=chfocus(0) src=\"/web/shared/images/fixed/keyboard/keyboard_tab_idoff.gif\" alt=\"ログインID\" />";
	 document.getElementById('key_tab1').innerHTML ="<img src=\"/web/shared/images/fixed/keyboard/keyboard_tab_passon.gif\" alt=\"パスワード\" />";
