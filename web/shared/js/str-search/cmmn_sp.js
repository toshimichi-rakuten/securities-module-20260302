...
function submitSearchResultAll(formname)
{
	...
	switch(number){
		//米国株式
		case '0': data = "/web/market/search/us_search/result.html?forwarding=na&target=0&theme=na&returns=na&head_office=na&sector=na&r1=on&all=on&vall=on";
			break;
		//中国株式
		case '1': data = '/web/market/search/china_search/result.html?catAll=on&forwarding=na&target=0&theme=na&returns=na&sector=na&r1=on&pageNo=';
			break;
		//アセアン株式
		case '2': data = "/web/market/search/asean_search/result.html?forwarding=na&target=na&theme=na&returns=na&sector=na&c=asn&p=result&freeword=";
			break;
	}
