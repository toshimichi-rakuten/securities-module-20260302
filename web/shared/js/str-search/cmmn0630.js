...
function changeSearchResult0630(form, select, text){
...
//	document.charset='shift_jis';
	...
	switch(number){
		...
		case '1': data = "https://www.trkd-asia.com/rakutensec/resultcnt_us.jsp?all=on&vall=on&forwarding=na&target=0&theme=na&returns=na&head_office=na&sector=na";
			break;
		//中国株
		case '2': data = "https://t1.trkd-asia.com/rakutensec/resultcnt_cn.jsp?all=on&catAll=on&forwarding=na&target=0&theme=na&returns=na&sector=na&pageNo=";
			break;
		//投資信託
