...
function reutersReload(){
	...
	sTag.charset="utf-8";
	sTag.src = 'https://www.trkd-asia.com/rakutensec/f_index1.jsp?date=' + dt.getTime();
	
	document.body.appendChild(sTag);
}

function get_reuters(){
	dt = new Date();
	var sTag = document.createElement("script");
	sTag.type="text/javascript";
	sTag.charset="utf-8";
...
function makeCopyright(tabNo) {
	...
	if(tabNo == 3) {
		...
		strCopyright = '<table style="margin-bottom:0px" summary="コピーライト"><tr><td style="padding:0px;border-bottom:0px;border-right:0px;text-align:right">&copy; 2010 Thomson Reuters</td></tr></table>';
	}
...
function open_reuters(mmf)
{
  var str = "<div id=\"updateBtnOn\">";
      str  = str + "<div class=\"delay-container\">";
      str  = str + "<p class=\"delay\"><span id=\"reuters_date\"></span>&nbsp\;<span id=\"reuters_time\"></span></p>";
      str  = str + "<p class=\"btn-renew\"><a href=\"javascript:reutersReload()\"><img src=\"/web/shared/images/reuters/btn-renew-02.gif\" alt=\"更新する\" width=\"61\" height=\"18\" /></a></p>";
      str  = str + "<p class=\"note\">国内20分・海外その他最低15分ディレイ</p>";
      str  = str + "</div>";
      str  = str + "</div>";

      str  = str + "<div id=\"updateBtnOff\" style=\"display:none\">";
      str  = str + "<div class=\"delay-container\">";
      str  = str + "<p class=\"delay\"><span id=\"reuters_date2\"></span>&nbsp\;<span id=\"reuters_time2\"></span></p>";
      str  = str + "<p class=\"note\">国内20分・海外その他最低15分ディレイ</p>";
      str  = str + "</div>";
      str  = str + "</div>";

      str  = str + "<div id=\"reuters_chart_tab\">";
      str  = str + "<ul class=\"nav-tab\">";
      str  = str + "<li class=\"selected\"><a href=\"javascript:reutersChangeDisplay(0)\"><img src=\"/web/shared/images/reuters/top-tab-s-condition-h.gif\" alt=\"市況\" /></a></li>";
      str  = str + "<li><a href=\"javascript:reutersChangeDisplay(1)\"><img src=\"/web/shared/images/reuters/top-tab-s-volume-o.gif\" alt=\"東証一部 売買代金・出来高\" /></a></li>";
      str  = str + "<li><a href=\"javascript:reutersChangeDisplay(2)\"><img src=\"/web/shared/images/reuters/top-tab-s-up-down-o.gif\" alt=\"東証一部 値上がり率・値下がり率\" /></a></li>";
      str  = str + "<li><a href=\"javascript:reutersChangeDisplay(3)\"><img src=\"/web/shared/images/reuters/top-tab-s-mmf-o.gif\" alt=\"外貨建てMMF 年換算利回り\" /></a></li>";
      str  = str + "</ul>";
      str  = str + "<h3 class=\"hdg-l6-01\" id=\"reuters_market_title\">日経平均</h3>";
      str  = str + "<div class=\"box-padding\">";
      str  = str + "<p class=\"image align-C\"><a href=\"/web/market/data/n225.html\" id=\"reuters_chart_link\"><img id=\"reuters_chart\" src=\"https://www.trkd-asia.com/rakutensec/common/analytic.jsp?ric=.N225&per=7&width=160&height=80&tp=0&sma=0&vol=0&mode=0\" alt=\"日経平均チャート\" width=\"160\" height=\"80\" /></a></p>";
      str  = str + "<div id=\"reuters_market_data\"></div>";
      str  = str + "</div>";
      str  = str + "</div>";

      str  = str + "<div id=\"reuters_ranking1\" style=\"display:none\">";
      str  = str + "<ul class=\"nav-tab\">";
      str  = str + "<li><a href=\"javascript:reutersChangeDisplay(0)\"><img src=\"/web/shared/images/reuters/top-tab-s-condition-o.gif\" alt=\"市況\" /></a></li>";
      str  = str + "<li class=\"selected\"><a href=\"javascript:reutersChangeDisplay(1)\"><img src=\"/web/shared/images/reuters/top-tab-s-volume-h.gif\" alt=\"東証一部 売買代金・出来高\" /></a></li>";
      str  = str + "<li><a href=\"javascript:reutersChangeDisplay(2)\"><img src=\"/web/shared/images/reuters/top-tab-s-up-down-o.gif\" alt=\"東証一部 値上がり率・値下がり率\" /></a></li>";
      str  = str + "<li><a href=\"javascript:reutersChangeDisplay(3)\"><img src=\"/web/shared/images/reuters/top-tab-s-mmf-o.gif\" alt=\"外貨建てMMF 年換算利回り\" /></a></li>";
      str  = str + "</ul>";
      str  = str + "<div class=\"box-padding\">";
      str  = str + "<h3 class=\"hdg-l6-01 up-01\" id=\"rank1label\">東証一部 売買代金上位</h3>";
      str  = str + "<div id=\"mRank1\" name=\"mRank1\">";
      str  = str + "<div id=\"reuters_trading_table\"></div>";
      str  = str + "</div>";
      str  = str + "<h3 class=\"hdg-l6-01 down-01\" id=\"rank2label\">東証一部 出来高上位</h3>";
      str  = str + "<div id=\"mRank2\" name=\"mRank2\">";
      str  = str + "<div id=\"reuters_performance_table\"></div>";
      str  = str + "</div>";
      str  = str + "</div>";
      str  = str + "</div>";

      str  = str + "<div id=\"reuters_ranking2\" style=\"display:none\">";
      str  = str + "<ul class=\"nav-tab\">";
      str  = str + "<li><a href=\"javascript:reutersChangeDisplay(0)\"><img src=\"/web/shared/images/reuters/top-tab-s-condition-o.gif\" alt=\"市況\" /></a></li>";
      str  = str + "<li><a href=\"javascript:reutersChangeDisplay(1)\"><img src=\"/web/shared/images/reuters/top-tab-s-volume-o.gif\" alt=\"東証一部 売買代金・出来高\" /></a></li>";
      str  = str + "<li class=\"selected\"><a href=\"javascript:reutersChangeDisplay(2)\"><img src=\"/web/shared/images/reuters/top-tab-s-up-down-h.gif\" alt=\"東証一部 値上がり率・値下がり率\" /></a></li>";
      str  = str + "<li><a href=\"javascript:reutersChangeDisplay(3)\"><img src=\"/web/shared/images/reuters/top-tab-s-mmf-o.gif\" alt=\"外貨建てMMF 年換算利回り\" /></a></li>";
      str  = str + "</ul>";
      str  = str + "<div class=\"box-padding\">";
      str  = str + "<h3 class=\"hdg-l6-01 up-01\" id=\"rank1label\">東証一部 値上がり率上位</h3>";
      str  = str + "<div id=\"mRank1\" name=\"mRank1\">";
      str  = str + "<div id=\"reuters_increase_table\"></div>";
      str  = str + "</div>";
      str  = str + "<h3 class=\"hdg-l6-01 down-01\" id=\"rank2label\">東証一部 値下がり率上位</h3>";
      str  = str + "<div id=\"mRank2\" name=\"mRank2\">";
      str  = str + "<div id=\"reuters_decrease_table\"></div>";
      str  = str + "</div>";
      str  = str + "</div>";
      str  = str + "</div>";

      str  = str + "<div id=\"mmf_yield\" style=\"display:none\">";
      str  = str + "<ul class=\"nav-tab\">";
      str  = str + "<li><a href=\"javascript:reutersChangeDisplay(0)\"><img src=\"/web/shared/images/reuters/top-tab-s-condition-o.gif\" alt=\"市況\" /></a></li>";
      str  = str + "<li><a href=\"javascript:reutersChangeDisplay(1)\"><img src=\"/web/shared/images/reuters/top-tab-s-volume-o.gif\" alt=\"東証一部 売買代金・出来高\" /></a></li>";
      str  = str + "<li><a href=\"javascript:reutersChangeDisplay(2)\"><img src=\"/web/shared/images/reuters/top-tab-s-up-down-o.gif\" alt=\"東証一部 値上がり率・値下がり率\" /></a></li>";
      str  = str + "<li class=\"selected\"><a href=\"javascript:reutersChangeDisplay(3)\"><img src=\"/web/shared/images/reuters/top-tab-s-mmf-h.gif\" alt=\"外貨建てMMF 年換算利回り\" /></a></li>";
      str  = str + "</ul>";
      str  = str + "<p class=\"date-mmf\">直近7日間（更新日：" + mmf[0] + "）</p>";

      str  = str + "<div class=\"box-padding\">";
      str  = str + "<table class=\"tbl-data-03 margin-reset-01\" border=\"1\" cellspacing=\"0\" summary=\"外貨建てMMF年換算利回り（税引前）\">";
      str  = str + "<tr class=\"odd\">";
      str  = str + "<th class=\"flag\"><img src=\"/web/shared/images/flags/flag_us_18x12.gif\" width=\"18\" height=\"12\" border=\"0\" alt=\"\" /></th>";
      str  = str + "<th><a href=\"/web/fund/foreign_mmf/\" onclick=\"s.lidTrack(\'vtop_market_fmmf_usd\')\">米ドルMMF</a></th>";
      str  = str + "<td class=\"yield\">" + mmf[1] + "％</td>";
      str  = str + "</tr>";

      str  = str + "<tr>";
      str  = str + "<th class=\"flag\"><img src=\"/web/shared/images/flags/flag_ca_18x12.gif\" width=\"18\" height=\"12\" border=\"0\" alt=\"\" /></th>";
      str  = str + "<th><a href=\"/web/fund/foreign_mmf/\" onclick=\"s.lidTrack(\'vtop_market_fmmf_cad\')\">カナダドルMMF</a></th>";
      str  = str + "<td class=\"yield\">" + mmf[2] + "％</td>";
      str  = str + "</tr>";
      str  = str + "<tr class=\"odd\">";
      str  = str + "<th class=\"flag\"><img src=\"/web/shared/images/flags/flag_za_18x12.gif\" width=\"18\" height=\"12\" border=\"0\" alt=\"\" /></th>";
      str  = str + "<th><a href=\"/web/fund/foreign_mmf/\" onclick=\"s.lidTrack(\'vtop_market_fmmf_land\')\">南ア・ランドMMF</a></th>";
      str  = str + "<td class=\"yield\">" + mmf[3] + "％</td>";
      str  = str + "</tr>";

      str  = str + "<tr>";
      str  = str + "<th class=\"flag\"><img src=\"/web/shared/images/flags/flag_nz_18x12.gif\" width=\"18\" height=\"12\" border=\"0\" alt=\"\" /></th>";
      str  = str + "<th><a href=\"/web/fund/foreign_mmf/\" onclick=\"s.lidTrack(\'vtop_market_fmmf_nzd\')\">NZドルMMF</a></th>";
      str  = str + "<td class=\"yield\">" + mmf[4] + "％</td>";
      str  = str + "</tr>";
      str  = str + "<tr class=\"odd\">";
      str  = str + "<th class=\"flag\"><img src=\"/web/shared/images/flags/flag_au_18x12.gif\" width=\"18\" height=\"12\" border=\"0\" alt=\"\" /></th>";
      str  = str + "<th><a href=\"/web/fund/foreign_mmf/\" onclick=\"s.lidTrack(\'vtop_market_fmmf_aud\')\">豪ドルMMF</a></th>";
      str  = str + "<td class=\"yield\">" + mmf[5] + "％</td>";
      str  = str + "</tr>";

      str  = str + "</table>";
      str  = str + "</div>";
      str  = str + "</div>";
      str  = str + "<div id=\"copyrightPlus\"></div>";

  $("#reuters .box-inner-02").html(str);
}
