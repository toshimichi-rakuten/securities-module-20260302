...
(function($) {
  ...
  if($.cookie("Rg_sec") === null){
    ...
    document.cookie = 'bname=AL_;path=/web;';
    document.cookie = 'refferrerURL=algoKey=' + akey + '&fxSameOpnFlg=1;path=/web;';
