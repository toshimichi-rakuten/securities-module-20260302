...
var stopAdobeList = [
  ["https://www.rakuten-sec.co.jp/smartphone/campaign/20180831-01/", 0],
  ["end","_"]
 ];

var stopAdobeJudge = "no";

for(var i=0; i<stopAdobeList.length; i++){
 if(stopAdobeList[i][0]!=="end"){
  if(window.location.href==stopAdobeList[i][0] && stopAdobeList[i][1]==0){
   stopAdobeJudge = "yes";
  }else if(window.location.href.startsWith(stopAdobeList[i][0])&&stopAdobeList[i][1]==1){
   stopAdobeJudge = "yes";
  }
 }
};
...
// To stop sending web beacon of Adobe Analytics, add the following determination

if(stopAdobeJudge != "yes"){s.doPlugins = s_doPlugins};
/************************** PLUGINS SECTION *************************/
